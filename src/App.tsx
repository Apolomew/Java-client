            ...
            <ModalsProvider>
              ...
              <Routes>
                ...
                <Route path="/admin" element={<Admin/>}>
                  ...
                  {/* ADDRESS */}
                  <Route path={ManagerPath.WARD} element={<AddressManage/>}/>
                  <Route path={ManagerPath.WARD + '/create'} element={<AddressCreate/>}/>
                  <Route path={ManagerPath.WARD + '/update/:id'} element={<AddressUpdate/>}/>
                  {/* PROVINCE */}
